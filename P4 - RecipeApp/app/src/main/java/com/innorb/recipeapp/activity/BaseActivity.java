...
public class BaseActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            openNavDetailActivity(Constants.TAB_ORDER_INGREDIENT);
            ...
            openNavDetailActivity(Constants.TAB_ORDER_STEP);
    ...
    private void openNavDetailActivity(int orderTab) {
        if (getRecipeId() > 0) {
            startActivity(new Intent(this, DetailActivity.class)
                    .putExtra(Constants.EXTRA_RECIPE_ID, getRecipeId())
                    .putExtra(Constants.EXTRA_RECIPE_NAME, getRecipeName())
                    .putExtra(Constants.EXTRA_TAB_ORDERTAB, orderTab)
            );
        }
    }
